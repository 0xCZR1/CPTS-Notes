...
```bash
0xCZR@htb[/htb]$ sudo nmap 10.129.2.0/24 -F
...
```bash
0xCZR@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --initial-rtt-timeout 50ms --max-rtt-timeout 100ms
...
```bash
0xCZR@htb[/htb]$ sudo nmap 10.129.2.0/24 -F | grep "/tcp" | wc -l
...
```bash
0xCZR@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --max-retries 0 | grep "/tcp" | wc -l
...
```bash
0xCZR@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.default
...
```bash
0xCZR@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.minrate300 --min-rate 300
...
```bash
0xCZR@htb[/htb]$ cat tnet.default | grep "/tcp" | wc -l
...
```bash
0xCZR@htb[/htb]$ cat tnet.minrate300 | grep "/tcp" | wc -l
...
```shell-session
0xCZR@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.T5 -T 5
...
```shell-session
0xCZR@htb[/htb]$ cat tnet.T5 | grep "/tcp" | wc -l
